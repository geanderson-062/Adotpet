  ...
  <body>
    ...
    <section class="container">
        <div class="text-dark text-center container pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center text-dark"> 
          <h1 class="display-4">Primeiro passo finalizado<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
            ...
            <p class="fs-3">No prazo de 72h úteis entraremos em contato para darmos continuidade! <br> <br>Anote seu número de protocolo: <?php
            ...
            <a href= "../../../index.html" type="button" class="btn btn-secondary btn-lg">Página Inicial
            </a>
