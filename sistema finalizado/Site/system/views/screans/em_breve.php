...
<meta name="theme-color" content="#38b6ff">
  ...
  <body>
    ...
    <section class="container text-center">
      <p class="fw-normal">
        Volte em breve para ter acesso as novas funcionalides! <br>
  ...
  <footer class="py-3 my-4 corPrimaria">
    <ul class="nav justify-content-center border-bottom pb-3 mb-3 ">
      ...
      <li class="nav-item"><a href="quem_somos.html" class="nav-link px-2  text-white">Quem nós somos?</a></li>
      <li class="nav-item"><a href="doacoes.html" class="nav-link px-2  text-white">Doações</a></li>
      <li class="nav-item"><a href="contato.html" class="nav-link px-2  text-white">Contato</a></li>
      <li class="nav-item"><a href="politica_de_privacidade.html" class="nav-link px-2  text-white">Política de Privacidade</a></li>
